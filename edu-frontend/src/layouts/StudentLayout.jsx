...
const StudentLayout = () => {
  ...
  const menuItems = [
    ...
    { label: 'Enroll Course', path: '/student/enroll', icon: UserPlus },
    { label: 'My Courses', path: '/student/courses', icon: GraduationCap },
    { label: 'DBMS Recommender', path: '/student/dbms-recommender', icon: BookOpen },
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <h1 className="text-lg font-bold bg-gradient-to-r from-primary-500 to-secondary-500 dark:from-dark-green-500 dark:to-secondary-600 bg-clip-text text-transparent">
                Skill-Sync : Student Learning Portal
              </h1>
            </div>
          </div>
